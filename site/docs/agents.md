...
layout: default
title: "For agents"
description: "The agent-facing CLI guide that pwt skill prints."
...
This is what `pwt skill` prints. Point your agent at it:

```bash
pwt skill              # print the guide
pwt skill --install    # copy it into your agent's skills directory
```
