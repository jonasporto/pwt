...
complete -c pwt -n __pwt_needs_command -a shell -d 'Interactive shell'
...
complete -c pwt -n __pwt_needs_command -a pick -d 'Interactive select (fzf)'
complete -c pwt -n __pwt_needs_command -a select -d 'Interactive selector (fzf)'
...
complete -c pwt -n '__pwt_using_command shell' -a '(__pwt_worktrees)' -d 'Worktree'
