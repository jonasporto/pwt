...
Alias for [`pwt adopt`](#adopt).

## pwt list {#list}

Also available as [`ls`](#ls).
...
Alias for [`pwt info`](#info).

## pwt remove {#remove}

Also available as [`rm`](#rm).
...
Alias for [`pwt remove`](#remove).

## pwt server {#server}

Also available as [`s`](#s).
...
Alias for [`pwt repair`](#repair).

## pwt auto-remove {#auto-remove}

Also available as [`cleanup`](#cleanup).
...
Alias for [`pwt auto-remove`](#auto-remove).
...
Also available as [`versions`](#versions), [`which`](#which).
